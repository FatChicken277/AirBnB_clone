...
EOF  all  count  create  destroy  help  quit  show  update\n\n"""
    ...
    def test_quit(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_quit.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_EOF(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_EOF.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_create(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_create.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_show(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_show.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_destroy(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_destroy.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_all(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_all.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_update(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_update.__doc__ + "\n"
        self.assertEqual(val, msg)
    ...
    def test_count(self):
        ...
        val = f.getvalue()
        msg = HBNBCommand.do_count.__doc__ + "\n"
        self.assertEqual(val, msg)
